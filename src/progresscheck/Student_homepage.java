...
public class Student_homepage extends javax.swing.JFrame {
    ...
    void username_get(String user1)
     {
        // JOptionPane.showMessageDialog(null, "received"+user1);
         user=user1;
         username2.setText("Welcome:"+user1);
         //JOptionPane.showMessageDialog(null,"Welcome student:"+user1);
        ...
        try{
               ...
               // JOptionPane.showMessageDialog(null,query);
                ...
                while(rs.next())
                {
                    ...
                    username2.setText("Welcome: "+user2);
                }
    ...
    private void initComponents() {
        ...
        disp.setFont(new java.awt.Font("Microsoft New Tai Lue", 1, 24)); // NOI18N
        disp.setForeground(new java.awt.Color(116, 116, 116));
        disp.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        disp.setText("Are you ready for the exam? Good Luck!");
        jPanel1.add(disp, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 120, 470, 80));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 210, 230, 70));

        jButton1.setBackground(new java.awt.Color(255, 228, 0));
        jButton1.setFont(new java.awt.Font("Sylfaen", 1, 18)); // NOI18N
        jButton1.setForeground(new java.awt.Color(20, 167, 108));
        jButton1.setText("OPERATING SYSTEMS");
        jButton1.setActionCommand("OOP CONCEPTS");
        jButton1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(20, 167, 108)));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 210, 240, 70));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/student2.png"))); // NOI18N
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 190, 280, 330));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/student1.png"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 190, 280, 320));

        username2.setFont(new java.awt.Font("Microsoft New Tai Lue", 1, 24)); // NOI18N
        username2.setForeground(new java.awt.Color(116, 116, 116));
        username2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        username2.setText("WELCOME");
        jPanel1.add(username2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 20, 430, 80));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Assignments form = new Assignments();
